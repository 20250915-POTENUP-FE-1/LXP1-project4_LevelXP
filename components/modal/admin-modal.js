  ...
  <div class="modal-content">
    ...
    _bind() {
      ...
      this.modalEl.addEventListener("click", (e) => {
        const role =
          e.target.getAttribute && e.target.getAttribute("data-role");
      ...
      this.modalEl.addEventListener("change", (e) => {
        ...
        if (
          target.id === "upfile" ||
          (target.matches && target.matches('input[type="file"]#upfile'))
        ) {
          this._refreshRefs();
          if (!this.previewWrap) {
            ...
            const parent =
              target.parentNode ||
              this.modalEl.querySelector(".files-upload-input") ||
              this.modalEl;
      ...
      this.modalEl.addEventListener("click", (e) => {
        ...
        let preview =
          this.modalEl.querySelector("#preview-wrap") || this.previewWrap;
        if (preview) {
